...
type Config struct {
	...
	MaxPeers         int           `yaml:"MaxPeers" env:"P2P_MAX_PEERS" env-default:"350" env-description:"Connected peers limit, starting from this number only relevant nodes will be connectable"`
